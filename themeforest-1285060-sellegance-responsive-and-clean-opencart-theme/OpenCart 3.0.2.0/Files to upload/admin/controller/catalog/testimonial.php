...
class ControllerCatalogTestimonial extends Controller { 
	...
	protected function getList() {
		...
		$data['breadcrumbs'] = array();
   		...
   		$data['breadcrumbs'][] = array(
			...
			'href'	=> $this->url->link('catalog/testimonial', 'user_token=' . $this->session->data['user_token'] . $url, true)
   		);
							
		$data['insert'] = $this->url->link('catalog/testimonial/insert', 'user_token=' . $this->session->data['user_token'] . $url, true);
		$data['delete'] = $this->url->link('catalog/testimonial/delete', 'user_token=' . $this->session->data['user_token'] . $url, true);	
		$data['module_settings_path'] = $this->url->link('module/testimonial', 'user_token=' . $this->session->data['user_token'] . $url, true);	
		...
		foreach ($results as $result) {
			...
			$action[] = array(
				...
				'href' => $this->url->link('catalog/testimonial/update', 'user_token=' . $this->session->data['user_token']. '&testimonial_id=' . $result['testimonial_id'] . $url, true)
		...
		$data['sort_title'] = $this->url->link('catalog/testimonial', 'user_token=' . $this->session->data['user_token'] . '&sort=td.title' . $url, true);
		$data['sort_date_added'] = $this->url->link('catalog/testimonial', 'user_token=' . $this->session->data['user_token'] . '&sort=t.date_added' . $url, true);		
		$data['sort_status'] = $this->url->link('catalog/testimonial', 'user_token=' . $this->session->data['user_token'] . '&sort=t.status' . $url, true);		
		$data['sort_name'] = $this->url->link('catalog/testimonial', 'user_token=' . $this->session->data['user_token'] . '&sort=t.name' . $url, true);		
		$data['sort_description'] = $this->url->link('catalog/testimonial', 'user_token=' . $this->session->data['user_token'] . '&sort=td.description' . $url, true);		
	...
	private function getForm($is_edit) {
		...
		if (!isset($this->request->get['testimonial_id'])) {
			$data['action'] = $this->url->link('catalog/testimonial/insert', 'user_token=' . $this->session->data['user_token'] . $url, true);		
		} else {
			$data['action'] = $this->url->link('catalog/testimonial/update', 'user_token=' . $this->session->data['user_token'] . '&testimonial_id=' . $this->request->get['testimonial_id'] . $url, true);
		}
		
		$data['cancel'] = $this->url->link('catalog/testimonial', 'user_token=' . $this->session->data['user_token'] . $url, true);
