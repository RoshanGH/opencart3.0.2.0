...
//end revsslider custom code
		...
		$data['breadcrumbs'][] = array(
			...
			'href'      => $this->url->link('extension/module/revslideropencart', 'user_token=' . $this->session->data['user_token'], true),
			'separator' => ' :: '
		);
// start language
...
// end language
		...
		$data['action'] = $this->url->link('extension/module/revslideropencart', 'user_token=' . $this->session->data['user_token'], true);
