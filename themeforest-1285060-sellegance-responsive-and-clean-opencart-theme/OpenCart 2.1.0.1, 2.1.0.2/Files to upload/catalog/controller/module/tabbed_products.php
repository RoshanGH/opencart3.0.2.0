...
class ControllerModuleTabbedProducts extends Controller {
	public function index($setting) {
		...
		if (file_exists(DIR_TEMPLATE . $this->config->get('config_template') . '/template/module/tabbed_products.tpl')) {
				return $this->load->view($this->config->get('config_template') . '/template/module/tabbed_products.tpl', $data);
		} else {
				return $this->load->view('default/template/module/tabbed_products.tpl', $data);
		}
		}
	}
}
