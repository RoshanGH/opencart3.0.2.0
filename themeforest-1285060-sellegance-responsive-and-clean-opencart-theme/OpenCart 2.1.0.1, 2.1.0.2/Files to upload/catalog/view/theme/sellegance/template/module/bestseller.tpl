...
if($config->get('sellegance_bestseller_carousel') != '') {
...
?>
	...
	<div id="bestseller-products" class="<?php echo $class1; ?>" <?php if ($language->get('direction')=='rtl') echo 'style="direction:rtl;"'?>>
	...
	<?php if($config->get('sellegance_bestseller_carousel') != '') { ?>
