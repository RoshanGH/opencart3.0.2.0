...
if($config->get('sellegance_special_carousel') != '') {
...
?>
	...
	<div id="special-products" class="<?php echo $class1; ?>" <?php if ($language->get('direction')=='rtl') echo 'style="direction:rtl;"'?>>
	...
	<?php if($config->get('sellegance_special_carousel') != '') { ?>
