...
$anylist_carousel=true;
if($anylist_carousel== true) {
...
<div class="anylist-products <?php echo $class1; ?>" <?php if ($language->get('direction')=='rtl') echo 'style="direction:rtl;"'?>>
	...
	<script type="text/javascript">
		...
		$(document).ready(function() {
			$('.anylist-products .owl-carousel').owlCarousel({
				items: 4,
