			...
			<div class="blog_stats">
				...
				<?php } ?>
										...
										<?php if ((float)VERSION >= 2.1) { ?>
											<button type="button" onclick="cart.add('<?php echo $product['product_id']; ?>', '<?php echo $product['minimum']; ?>');" class="btn btn-cart"><span class="hidden-xs"><?php echo $button_cart; ?></span><i class="fa fa-shopping-cart visible-xs"></i></button>
										<?php } else { ?>
											<button type="button" onclick="cart.add('<?php echo $product['product_id']; ?>');" class="btn btn-cart"><span class="hidden-xs"><?php echo $button_cart; ?></span><i class="fa fa-shopping-cart visible-xs"></i></button>
										<?php } ?>
										</div>
									</div>
			</div>
