...
class ModelCatalogTab extends Model {
	...
	public function getTab($tab_id) {
		$query = $this->db->query("SELECT * FROM " . DB_PREFIX . "tab a LEFT JOIN " . DB_PREFIX . "tab_description ad ON (a.tab_id = ad.tab_id) WHERE a.tab_id = '" . (int)$tab_id . "' AND ad.language_id = '" . (int)$this->config->get('config_language_id') . "'");
