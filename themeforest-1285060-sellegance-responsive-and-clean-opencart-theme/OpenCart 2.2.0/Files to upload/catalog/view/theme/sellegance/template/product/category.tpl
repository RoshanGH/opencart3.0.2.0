		...
		<div id="content" class="<?php echo $class; ?> category" role="main">
			...
			<div class="mainborder">
				...
				<div class="category-details">
					...
					<?php if ($categories && $config->get('sellegance_subcat_status') == 1) { ?>

						<?php if($config->get('sellegance_subcat_thumbnails_status') != 1){ ?>
					...
					<div class="product-filter">
						...
						<?php if($categories && $config->get('sellegance_subcat_status') == 1 && $config->get('sellegance_subcat_thumbnails_status') == 1){ ?>
