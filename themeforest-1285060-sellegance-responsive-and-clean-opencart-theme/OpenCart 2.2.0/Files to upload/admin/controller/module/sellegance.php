...
class ControllerModuleSellegance extends Controller {
    ...
    public function index() {   
		...
		if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validate()) {
            ...
            $this->response->redirect($this->url->link('module/sellegance&submit=true', 'token=' . $this->session->data['token'], 'true'));
        ...
        $data['breadcrumbs'][] = array(
            ...
            'href'      => $this->url->link('module/sellegance', 'token=' . $this->session->data['token'], 'true'),
            'separator' => ' :: '
        );
        
        $data['action'] = $this->url->link('module/sellegance', 'token=' . $this->session->data['token'], 'true');
        ...
        //Send the output.
        $this->response->setOutput($this->load->view('module/sellegance', $data));
    }
