...
//end revsslider custom code
		...
		$data['breadcrumbs'][] = array(
			...
			'href'      => $this->url->link('module/revslideropencart', 'token=' . $this->session->data['token'], true),
			'separator' => ' :: '
		);
// start language
...
// end language
		...
		$data['action'] = $this->url->link('module/revslideropencart', 'token=' . $this->session->data['token'], true);
...
//end revsslider custom code
		...
		$this->response->setOutput($this->load->view('module/revslideropencart', $data));
	}
