...
$_['entry_limit_help']    = 'If no items are selected AnyList always will be shown. If select any item, only when any of this items are shown AnyList will be visible.';
