...
class ControllerModuleSellegance extends Controller {
    ...
    public function index() {   
		...
		if (isset($this->request->post['store_id'])) {
			...
			$this->data['store_id'] = $this->config->get('sellegance_store_id');
		}
	...
	'sellegance_rollover_images',
        ...
        'sellegance_custom_block',
        'sellegance_custom_block_status',
        'sellegance_custom_block_title',
        'sellegance_custom_block_link',
        'sellegance_custom_block_tag',
        'sellegance_custom_block_tag_color',
        ...
        'sellegance_custom_icon_class',
        'sellegance_custom_icon_url',
        'sellegance_custom_icon_color',
		...
		$this->data['sellegance_conf'] = $this->model_setting_setting->getSetting('sellegance', $this->data['store_id']);
		
        foreach ($config_data as $conf) {
            if (isset($this->request->post[$conf])) {
                $this->data[$conf] = $this->request->post[$conf];
            } else {
				if(isset($this->data['sellegance_conf'][$conf])) {
					$this->data[$conf] = $this->data['sellegance_conf'][$conf];
				} else {
		...
		if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validate()) {
			...
			$this->model_setting_setting->editSetting('sellegance_store_id', $this->data['array']);	

			$this->session->data['success'] = $this->language->get('text_success');

           	$this->redirect(HTTPS_SERVER . 'index.php?route=module/sellegance&submit=true&token=' . $this->session->data['token']);
