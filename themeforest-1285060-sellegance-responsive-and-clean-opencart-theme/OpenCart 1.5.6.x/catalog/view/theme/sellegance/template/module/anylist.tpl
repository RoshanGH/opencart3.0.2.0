...
<?php $sellegance_anylist_carousel = 1; ?>

<?php if($sellegance_anylist_carousel==1) { ?>

	<section class="anylist-products product-slider top-arrows" <?php if ($this->language->get('direction')=='rtl') echo 'style="direction:ltr;"'?>>

		<div class="contentset center">
			<h4 class="inner"><span>
			<?php echo ($titlelink) ? '<a href="'.$titlelink.'">' : ''; ?><?php echo $heading_title; ?><?php echo ($titlelink) ? '</a>' : ''; ?>
			</span></h4>
		</div>
	...
	<script type="text/javascript">
		...
		$(document).ready(function() {
			$('.anylist-products .flexslider').flexslider({
				animation: "slide",
				animationLoop: true,
				itemWidth: 182,
				itemMargin: 10,
...
<?php } else { ?>
	...
	<section class="anylist-products box">
