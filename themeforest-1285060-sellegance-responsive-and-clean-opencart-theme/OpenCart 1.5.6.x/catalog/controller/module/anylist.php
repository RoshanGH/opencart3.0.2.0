...
class ControllerModuleAnylist extends Controller {
	protected function index($setting) {
		...
		if (isset($setting['date_start']) and $setting['date_start'] and strtotime($setting['date_start'])>time()) {
			$outofperiod = true;		
		}

		if (isset($setting['date_end']) and $setting['date_end'] and strtotime($setting['date_end'])<time()) {
			$outofperiod = true;		
		}
