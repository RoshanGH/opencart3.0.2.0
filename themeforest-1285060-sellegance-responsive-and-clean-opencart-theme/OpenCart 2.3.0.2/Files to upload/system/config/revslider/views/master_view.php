...
<script type="text/javascript">
	...
	var g_urlContent = "<?php echo rev_slider_url().'/'; ?>";
     ...
     // var ajaxurl = g_urlContent+'ajax.php?returnurl=<?php echo $sds_admin_url; ?>';
      //var ajaxurl = "<?php echo rev_site_admin_url(); ?>?route=extension/module/revslideropencart/ajaxexecute&token=eee5a3fd43e79be92be35b45b9db59e6&returnurl=<?php echo $sds_admin_url; ?>";
      var ajaxurl = "<?php echo rev_site_admin_url(); ?>?route=extension/module/revslideropencart/ajaxexecute&token=<?php echo sds_get_oc_token(); ?>&returnurl=<?php echo $sds_admin_url; ?>";
