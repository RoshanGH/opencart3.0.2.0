...
class ControllerExtensionModuleNewsletter extends Controller {
	...
	public function index() {
		...
		if (!isset($this->request->get['module_id'])) {
			$data['action_global'] = $this->url->link('extension/module/newsletter', 'token=' . $this->session->data['token'], true);
		} else {
			$data['action_global'] = $this->url->link('extension/module/newsletter', 'token=' . $this->session->data['token'] . '&module_id=' . $this->request->get['module_id'], true);
		}
