...
class ControllerExtensionModuleSellegance extends Controller {
    ...
    public function index() {   
		...
		if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validate()) {
            ...
            $this->response->redirect($this->url->link('extension/module/sellegance&submit=true', 'token=' . $this->session->data['token'], 'true'));
       ...
       $data['breadcrumbs'][] = array(
        ...
        $data['breadcrumbs'][] = array(
            ...
            'href'      => $this->url->link('extension/module/sellegance', 'token=' . $this->session->data['token'], true)
        );
        
        $data['action'] = $this->url->link('extension/module/sellegance', 'token=' . $this->session->data['token'], true);
