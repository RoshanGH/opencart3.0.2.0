...
class ControllerExtensionModuleAdvancedSlideshow extends Controller {
	...
	public function index() {   
		...
		$language = $this->load->language('extension/module/advanced_slideshow');
		...
		if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validate()) {
			...
			$this->response->redirect($this->url->link('extension/module/advanced_slideshow&submit=true', 'token=' . $this->session->data['token'], 'true'));
		...
		$data['breadcrumbs'][] = array(
			...
			'href'      => $this->url->link('extension/module/advanced_slideshow', 'token=' . $this->session->data['token'], true)
		);
		
		$data['action'] = $this->url->link('extension/module/advanced_slideshow', 'token=' . $this->session->data['token'], true);
		...
		//Send the output.
		$this->response->setOutput($this->load->view('extension/module/advanced_slideshow', $data));
	}
	...
	private function validate() {
		if (!$this->user->hasPermission('modify', 'extension/module/advanced_slideshow')) {
