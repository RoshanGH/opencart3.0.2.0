	...
	<div class="page-header">
		<div class="container-fluid">
			<div class="pull-right">
				<button type="submit" form="form-tabbed" data-toggle="tooltip" title="<?php echo $button_save; ?>" class="btn btn-primary"><i class="fa fa-save"></i></button>
	...
	<div class="container-fluid">
		...
		<div class="panel panel-default">
			...
			<div class="panel-body">
				...
				<form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form-tabbed" class="form-horizontal">
							...
							<div class="col-sm-10">
								<select name="latest" id="input-latest" class="form-control">
									<?php foreach ($displaymode as $dv => $dc) { ?>
										<?php ($dv ==  $latest) ? $dspmode = 'selected' : $dspmode=''; ?>
						...
						<div class="form-group">
							...
							<div class="col-sm-10">
								<select name="featured" id="input-featured" class="form-control">
									<?php foreach ($displaymode as $dv => $dc) { ?>
										<?php ($dv ==  $featured) ? $dspmode = 'selected' : $dspmode=''; ?>
										<option value="<?php echo $dv; ?>" <?php echo $dspmode; ?> ><?php echo $dc; ?></option> 
									<?php } ?>
								</select>
							</div>
						...
						<div class="form-group">
							...
							<div class="col-sm-10">
								<select name="special" id="input-special" class="form-control">
									<?php foreach ($displaymode as $dv => $dc) { ?>
										<?php ($dv ==  $special) ? $dspmode = 'selected' : $dspmode=''; ?>
										<option value="<?php echo $dv; ?>" <?php echo $dspmode; ?> ><?php echo $dc; ?></option> 
									<?php } ?>
								</select>
							</div>
						...
						<div class="form-group">
							...
							<div class="col-sm-10">
								<select name="bestseller" id="input-bestseller" class="form-control">
									<?php foreach ($displaymode as $dv => $dc) { ?>
										<?php ($dv ==  $bestseller) ? $dspmode = 'selected' : $dspmode=''; ?>
										<option value="<?php echo $dv; ?>" <?php echo $dspmode; ?> ><?php echo $dc; ?></option> 
									<?php } ?>
								</select>
							</div>
