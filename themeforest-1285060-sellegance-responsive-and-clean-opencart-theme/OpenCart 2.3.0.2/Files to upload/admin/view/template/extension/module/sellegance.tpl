							...
							<div class="form-group">
								...
								<div class="col-sm-10 ">
									<select name="sellegance_store_id" id="sellegance_store_id" class="form-control input">
										...
										<option value="<?php echo HTTPS_SERVER . 'index.php?route=extension/module/sellegance&store_id=' . $store['store_id'] . '&token=' . $token; ?>"<?php if($store_id == $store['store_id']) echo ' selected="selected"'; ?>><?php echo $store['name']; ?></option>
										<?php endforeach; ?>
									</select>
								</div>
							</div>					
							                ...
							                <div class="col-sm-10">
													...
													<?php } ?>
															...
															<ul id="menu_blocks_<?php echo $section_row; ?>" class="nav nav-tabs">
																<?php foreach ($languages as $language) { ?>
																	<li><a href="#custom_block_<?php echo $section_row; ?>_<?php echo $language['language_id']; ?>" data-toggle="tab"><img src="language/<?php echo $language['code']; ?>/<?php echo $language['code']; ?>.png" alt="<?php echo $language['name']; ?>" width="16px" height="11px" /> <?php echo $language['name']; ?></a></li>
																<?php } ?>
															</ul>
					                ...
					                <div class="col-sm-10">
						                ...
						                <div class="col-sm-10">
						                	<div class="row">
												...
												<div class="col-sm-2">
													<span class="help-block"><?php echo $entry_background_caption; ?></span>
																					<input type="text" name="sellegance_menu_blocks[<?php echo $section_row; ?>][tagcolor][<?php echo $language['language_id']; ?>]" value="<?php echo isset($menu_block['tagcolor'][$language['language_id']]) ? $menu_block['tagcolor'][$language['language_id']] : ''; ?>" size="6" class="color {required:false,hash:true}" />
												</div>
											</div>
						                </div>
					            	</div>
								...
								<div class="form-group">
									...
									<div class="col-sm-10">
										...
										<ul id="sellegance_header_info_text" class="nav nav-tabs">
											<?php foreach ($languages as $language) { ?>
												<li><a href="#sellegance_header_info_text_<?php echo $language['language_id']; ?>" data-toggle="tab"><img src="language/<?php echo $language['code']; ?>/<?php echo $language['code']; ?>.png" alt="<?php echo $language['name']; ?>" width="16px" height="11px" /> <?php echo $language['name']; ?></a></li>
											<?php } ?>
										</ul>
										<div class="tab-content">
											<?php foreach ($languages as $language) { ?>
												...
												<div id="sellegance_header_info_text_<?php echo $language_id; ?>" class="tab-pane">
													<textarea name="sellegance_header_info_text[<?php echo $language_id; ?>]" id="sellegance_header_info_text-<?php echo $language_id; ?>" class="summernote" ><?php echo isset($sellegance_header_info_text[$language_id]) ? $sellegance_header_info_text[$language_id] : ''; ?></textarea>
												</div>
								...
								<div class="form-group">
									...
									<div class="col-sm-10">
										...
										<ul id="sellegance_footer_info_text" class="nav nav-tabs">
											<?php foreach ($languages as $language) { ?>
												<li><a href="#sellegance_footer_info_text_<?php echo $language['language_id']; ?>" data-toggle="tab"><img src="language/<?php echo $language['code']; ?>/<?php echo $language['code']; ?>.png" alt="<?php echo $language['name']; ?>" width="16px" height="11px" /> <?php echo $language['name']; ?></a></li>
											<?php } ?>
										</ul>
										<div class="tab-content">
											<?php foreach ($languages as $language) { ?>
												...
												<div id="sellegance_footer_info_text_<?php echo $language_id; ?>" class="tab-pane">
													<textarea name="sellegance_footer_info_text[<?php echo $language_id; ?>]" id="sellegance_footer_info_text-<?php echo $language_id; ?>" class="summernote" ><?php echo isset($sellegance_footer_info_text[$language_id]) ? $sellegance_footer_info_text[$language_id] : ''; ?></textarea>
												</div>
								...
								<div class="form-group">
									...
									<div class="col-sm-10">
										...
										<ul id="sellegance_copyright" class="nav nav-tabs">
											<?php foreach ($languages as $language) { ?>
												<li><a href="#sellegance_copyright_<?php echo $language['language_id']; ?>" data-toggle="tab"><img src="language/<?php echo $language['code']; ?>/<?php echo $language['code']; ?>.png" alt="<?php echo $language['name']; ?>" width="16px" height="11px" /> <?php echo $language['name']; ?></a></li>
											<?php } ?>
										</ul>
										<div class="tab-content">
											<?php foreach ($languages as $language) { ?>
												...
												<div id="sellegance_copyright_<?php echo $language_id; ?>" class="tab-pane">
													<textarea name="sellegance_copyright[<?php echo $language_id; ?>]" id="sellegance_copyright-<?php echo $language_id; ?>" class="summernote" ><?php echo isset($sellegance_copyright[$language_id]) ? $sellegance_copyright[$language_id] : ''; ?></textarea>
												</div>
...
function addRow() {
	...
	html += '		<li><a href="#custom_block_' + section_row + '_<?php echo $language['language_id']; ?>" data-toggle="tab"><img src="language/<?php echo $language['code']; ?>/<?php echo $language['code']; ?>.png" alt="<?php echo $language['name']; ?>" width="16px" height="11px" /> <?php echo $language['name']; ?></a></li>';
	html += '	<?php } ?>';
	html += '</ul>';
