					...
					<div class="form-group">
						...
						<div class="col-sm-10 ">
							<select name="aslider_store_id" id="aslider_store_id" class="form-control input">
								...
								<option value="<?php echo HTTPS_SERVER . 'index.php?route=extension/module/advanced_slideshow&store_id=' . $store['store_id'] . '&token=' . $token; ?>"<?php if($store_id == $store['store_id']) echo ' selected="selected"'; ?>><?php echo $store['name']; ?></option>
								<?php endforeach; ?>
							</select>
						</div>
					</div>					
