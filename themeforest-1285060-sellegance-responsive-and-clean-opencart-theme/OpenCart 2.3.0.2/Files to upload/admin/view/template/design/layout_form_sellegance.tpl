      ...
      <div class="panel-body">
        <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form-layout" class="form-horizontal">
          <fieldset>
            ...
            <table id="route" class="table table-striped table-bordered table-hover">
              ...
              <tbody>
                ...
                <?php if($layout_route['route'] == 'common/home') {
                  $is_home = TRUE;
                  } ?>
          ...
          <fieldset>
            ...
            <?php $module_row = 0; ?>
            <div class="row">
              <div class="col-sm-12 <?php if (!isset($is_home) || $name == 'Footer' || $name == 'footer') echo 'hidden'; ?>">
                <table id="module-home-top" class="table table-striped table-bordered table-hover">
                  <thead>
                    <tr>
                      <td class="text-center">Home Top</td>
                    </tr>
                  </thead>
                  <tbody>
                    ...
                    <tr>
                      <td class="text-left"><div class="input-group">
                          ...
                          <div class="input-group-btn">
                            <button type="button" onclick="addModule('home-top');" data-toggle="tooltip" title="<?php echo $button_module_add; ?>" class="btn btn-primary btn-sm"><i class="fa fa-plus-circle"></i></button>
                          </div>
                        </div></td>
                    </tr>
                  </tfoot>
              ...
              <div class="col-lg-3 col-md-4 col-sm-12 <?php if ($name == 'Footer' || $name == 'footer') echo 'hidden'; ?>">
              ...
              <div class="col-lg-6 col-md-4 col-sm-12 <?php if ($name == 'Footer' || $name == 'footer') echo 'hidden'; ?>">
              ...
              <div class="col-sm-12 <?php if ($name == 'Footer' || $name == 'footer') echo 'visible'; else echo 'hidden'; ?>">
                <table id="module-footer" class="table table-striped table-bordered table-hover">
                  <thead>
                    <tr>
                      <td class="text-center"><?php //echo $text_footer; ?>Footer</td>
                    </tr>
                  </thead>
                  <tbody>
                    <?php foreach ($layout_modules as $layout_module) { ?>
                  ...
                  <tfoot>
                    <tr>
                      <td class="text-left"><div class="input-group">
                          ...
                          <div class="input-group-btn">
                            <button type="button" onclick="addModule('footer');" data-toggle="tooltip" title="<?php echo $button_module_add; ?>" class="btn btn-primary btn-sm"><i class="fa fa-plus-circle"></i></button>
                          </div>
                        </div></td>
                    </tr>
                  </tfoot>
...
$('#module-column-left, #module-column-right, #module-content-top, #module-content-bottom, #module-footer, #module-home-top').delegate('select[name*=\'code\']', 'change', function() {
...
$('#module-column-left, #module-column-right, #module-content-top, #module-content-bottom, #module-footer, #module-home-top').trigger('change');
//--></script> 
</div>
<?php echo $footer; ?>