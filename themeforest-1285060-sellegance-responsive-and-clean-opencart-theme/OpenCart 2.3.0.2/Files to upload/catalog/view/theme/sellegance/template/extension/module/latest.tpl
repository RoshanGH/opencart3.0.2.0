<?php if(isset($sellegance_latest_carousel) && $sellegance_latest_carousel != '') {
...
?>
	...
	<div id="latest-products" class="<?php echo $class1; ?>" <?php if ($direction=='rtl') echo 'style="direction:rtl;"'?>>
	...
	<?php if($sellegance_latest_carousel != '') { ?>
