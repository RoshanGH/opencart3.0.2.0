<?php 
if(isset($sellegance_bestseller_carousel) && $sellegance_bestseller_carousel != '') {
...
?>
	...
	<div id="bestseller-products" class="<?php echo $class1; ?>" <?php if ($direction=='rtl') echo 'style="direction:rtl;"'?>>
	...
	<?php if($sellegance_bestseller_carousel != '') { ?>
