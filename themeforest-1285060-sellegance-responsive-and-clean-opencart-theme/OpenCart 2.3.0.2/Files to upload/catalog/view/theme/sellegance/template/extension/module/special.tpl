<?php 
if(isset($sellegance_special_carousel) && $sellegance_special_carousel != '') {
...
?>
	...
	<div id="special-products" class="<?php echo $class1; ?>" <?php if ($direction=='rtl') echo 'style="direction:rtl;"'?>>
	...
	<?php if($sellegance_special_carousel != '') { ?>
