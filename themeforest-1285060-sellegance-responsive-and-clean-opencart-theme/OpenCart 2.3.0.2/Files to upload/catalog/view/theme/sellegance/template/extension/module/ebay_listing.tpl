<?php if(isset($sellegance_ebay_carousel) && $sellegance_ebay_carousel != '') {
...
?>
	...
	<div id="ebay-products" class="<?php echo $class1; ?>" <?php if ($direction=='rtl') echo 'style="direction:rtl;"'?>>
	...
	<?php if($sellegance_ebay_carousel != '') { ?>
