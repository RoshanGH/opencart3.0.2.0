...
if(isset($language_id)) { 
	...
	if(isset($aslider_general_status) && $aslider_general_status == '1') { ?>
	...
	<div class="fullwidthbanner-container">
		<div class="fullwidthbanner">
			...
			<?php 
				...
				for ($i = 1; $i <= $aslider_slides_qty; $i++) { 
					...
					if(isset($slider[$i][$language_id]['status'])) {
						...
						if($slider[$i][$language_id]['status'] == '1') {
							...
							for ($m = 1; $m <= $aslider_elements_qty; $m++) {
	...
	<style type="text/css">
		...
		.fullwidthbanner-container { max-height:<?php echo $aslider_height; ?>px !important; }
	</style>
...
<script type="text/javascript">
	...
	if ($.fn.cssOriginal!=undefined)
		...
		$('.fullwidthbanner').revolution({
			delay:<?php echo $aslider_delay*1000; ?>,
			<?php $layout = $sellegance_responsive_layout; ?>

			startwidth:<?php echo ($layout=='large') ? '1140' : '960';  ?>,
			startheight:<?php echo $aslider_height; ?>,
			...
			shuffle:"<?php echo ($aslider_shuffle_slides==1) ? 'on' : 'off'; ?>",
