...
<div class="centralbox">
		<div class="container">
			<div class="container-inner <?php echo $sellegance_product_title_position; ?>">
			...
			<div class="mainborder">
				...
				<div class="row">
					...
					<div class="col-sm-6 leftcol">
						...
						<?php $product_carousel=1; ?>
							...
							<?php if ($images) { ?>
								...
								<?php if($product_carousel==1 && $sellegance_cloud_zoom!=1) { ?>
                    ...
                    <?php } ?>
						...
						<?php if($sellegance_product_details_layout == 'accordion') { ?>
						...
						<div class="share">
							...
							<?php $url = urlencode($config_url."index.php?route=product/product&product_id=".$product_id); ?>
				...
				<?php if($sellegance_product_details_layout == 'tabs') { ?>
				...
				<?php if ($products) { 
					...
					if($sellegance_related_carousel != '') {
					...
					<div id="related-products" class="<?php echo $class1; ?>" <?php if ($direction=='rtl') echo 'style="direction:rtl;"'?>>
