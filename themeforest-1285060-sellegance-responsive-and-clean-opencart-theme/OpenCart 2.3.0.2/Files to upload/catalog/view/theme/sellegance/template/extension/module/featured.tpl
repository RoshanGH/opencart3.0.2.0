<?php if(isset($sellegance_featured_carousel) && $sellegance_featured_carousel != '') {
...
?>
	...
	<div id="featured-products" class="<?php echo $class1; ?>" <?php if ($direction=='rtl') echo 'style="direction:rtl;"'?>>
	...
	<?php if($sellegance_featured_carousel != '') { ?>
